...
function manageLeaderboard() {
    ...
    for (let i = 0; i < sortable.length; i++) {
        ...
        body === null || body === void 0 ? void 0 : body.appendChild(node);
    }
}
...
export function unpause() {
    var _a;
    (_a = document.getElementById('pause')) === null || _a === void 0 ? void 0 : _a.remove();
}
...
function resizeBackground(bg) {
    let scale = app.loader.resources['bg'].texture.width / app.loader.resources['bg'].texture.height;
