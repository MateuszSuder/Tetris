...
import { app, blockSize, pause, unpause, endScreen } from "./index";
...
export class Board {
    constructor(lvl) {
        ...
        this.textNodes = [];
        this.score = 0;
        this.tetrisLast = false; // To check for back-to-back tetris
        this.paused = true;
        this.level = lvl;
